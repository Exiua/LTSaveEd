...
public class InitializeElements {
    ...
    private final HashMap<ClothingType, Attribute[]> clothesMap = new HashMap<ClothingType, Attribute[]>();

    private final HashMap<ItemType, Attribute[]> itemsMap = new HashMap<ItemType, Attribute[]>();

    private final HashMap<WeaponType, Attribute[]> weaponsMap = new HashMap<WeaponType, Attribute[]>();
    ...
    public HashMap<ClothingType, Attribute[]> getClothesMap(){
        return clothesMap;
    }

    public HashMap<ItemType, Attribute[]> getItemsMap(){
        return itemsMap;
    }

    public HashMap<WeaponType, Attribute[]> getWeaponsMap(){
        return weaponsMap;
    }
    ...
    private void initializeBreastSizes(){
        ...
        for(String tier : tiers){
            for(String letter : letters){
                breastSizes.add((tier.isEmpty() ? tier : (tier + "-"))  + letter + "-cup");
            }
        }
    }
    ...
    private void initializeItemMaps(){
        ...
        clothesMap.put(ClothingType.TORSO_OVER, new Attribute[]{new Attribute("bloom_wasp609_rainCoat_rain_coat", "bloom_wasp609_rainCoat_rain_coat"), new Attribute("c4mg1rl_trickster_cloak", "c4mg1rl_trickster_cloak"), new Attribute("dsg_eep_ptrlequipset_stpvest", "dsg_eep_ptrlequipset_stpvest"), new Attribute("dsg_eep_riotarmorset_riotarmor", "dsg_eep_riotarmorset_riotarmor"), new Attribute("dsg_eep_servequipset_debuggerydo_enfdjacket", "dsg_eep_servequipset_debuggerydo_enfdjacket"), new Attribute("dsg_eep_servequipset_enfdjacket", "dsg_eep_servequipset_enfdjacket"), new Attribute("dsg_eep_servequipset_enfdwaistcoat", "dsg_eep_servequipset_enfdwaistcoat"), new Attribute("dsg_eep_servequipset_enfgreatcoat", "dsg_eep_servequipset_enfgreatcoat"), new Attribute("dsg_eep_servequipset_milsweatervest_crew", "dsg_eep_servequipset_milsweatervest_crew"), new Attribute("dsg_eep_servequipset_milsweatervest_crewen", "dsg_eep_servequipset_milsweatervest_crewen"), new Attribute("dsg_eep_servequipset_milsweater_crew", "dsg_eep_servequipset_milsweater_crew"), new Attribute("dsg_eep_servequipset_milsweater_crewen", "dsg_eep_servequipset_milsweater_crewen"), new Attribute("dsg_eep_servequipset_milsweater_vee", "dsg_eep_servequipset_milsweater_vee"), new Attribute("dsg_eep_tacequipset_hpltcarrier", "dsg_eep_tacequipset_hpltcarrier"), new Attribute("dsg_eep_tacequipset_pltcarrier", "dsg_eep_tacequipset_pltcarrier"), new Attribute("dsg_hlf_equip_rbandolier", "dsg_hlf_equip_rbandolier"), new Attribute("dsg_hlf_equip_rwebbing", "dsg_hlf_equip_rwebbing"), new Attribute("dsg_ljacket_ljacket", "dsg_ljacket_ljacket"), new Attribute("dsg_ljacket_ljacket_f", "dsg_ljacket_ljacket_f"), new Attribute("dsg_m65jacket_m65jacket", "dsg_m65jacket_m65jacket"), new Attribute("innoxia_butler_butler_jacket", "innoxia_butler_butler_jacket"), new Attribute("innoxia_darkSiren_siren_cloak", "innoxia_darkSiren_siren_cloak"), new Attribute("innoxia_japanese_haori", "innoxia_japanese_haori"), new Attribute("innoxia_lyssiethUniform_tunic", "innoxia_lyssiethUniform_tunic"), new Attribute("innoxia_scientist_lab_coat", "innoxia_scientist_lab_coat"), new Attribute("innoxia_torsoOver_apron", "innoxia_torsoOver_apron"), new Attribute("innoxia_torsoOver_beer_barrel", "innoxia_torsoOver_beer_barrel"), new Attribute("innoxia_torsoOver_blazer", "innoxia_torsoOver_blazer"), new Attribute("innoxia_torsoOver_christmas_jumper", "innoxia_torsoOver_christmas_jumper"), new Attribute("innoxia_torsoOver_dress_coat", "innoxia_torsoOver_dress_coat"), new Attribute("innoxia_torsoOver_feminine_blazer", "innoxia_torsoOver_feminine_blazer"), new Attribute("innoxia_torsoOver_fur_cloak", "innoxia_torsoOver_fur_cloak"), new Attribute("innoxia_torsoOver_himation", "innoxia_torsoOver_himation"), new Attribute("innoxia_torsoOver_hooded_cloak", "innoxia_torsoOver_hooded_cloak"), new Attribute("innoxia_torsoOver_hoodie", "innoxia_torsoOver_hoodie"), new Attribute("innoxia_torsoOver_keyhole_jumper", "innoxia_torsoOver_keyhole_jumper"), new Attribute("innoxia_torsoOver_open_front_cardigan", "innoxia_torsoOver_open_front_cardigan"), new Attribute("innoxia_torsoOver_ribbed_jumper", "innoxia_torsoOver_ribbed_jumper"), new Attribute("innoxia_torsoOver_suit_jacket", "innoxia_torsoOver_suit_jacket"), new Attribute("innoxia_torsoOver_vending_machine", "innoxia_torsoOver_vending_machine"), new Attribute("innoxia_torsoOver_womens_leather_jacket", "innoxia_torsoOver_womens_leather_jacket"), new Attribute("innoxia_torsoOver_womens_winter_coat", "innoxia_torsoOver_womens_winter_coat"), new Attribute("nerdlinger_builder_utility_jacket_utility_jacket", "nerdlinger_builder_utility_jacket_utility_jacket"), new Attribute("NoStepOnSnek_poncho_poncho", "NoStepOnSnek_poncho_poncho"), new Attribute("TonyJC_cropped_sweater", "TonyJC_cropped_sweater"), new Attribute("TonyJC_shoulderless_top", "TonyJC_shoulderless_top")});
        clothesMap.put(ClothingType.TORSO_UNDER, new Attribute[]{new Attribute("c4mg1rl_benevolent_kyudogi", "c4mg1rl_benevolent_kyudogi"), new Attribute("c4mg1rl_trickster_tunic", "c4mg1rl_trickster_tunic"), new Attribute("dsg_eep_ptrlequipset_flsldshirt", "dsg_eep_ptrlequipset_flsldshirt"), new Attribute("dsg_eep_ptrlequipset_fssldshirt", "dsg_eep_ptrlequipset_fssldshirt"), new Attribute("dsg_eep_ptrlequipset_lsldshirt", "dsg_eep_ptrlequipset_lsldshirt"), new Attribute("dsg_eep_ptrlequipset_ssldshirt", "dsg_eep_ptrlequipset_ssldshirt"), new Attribute("dsg_eep_tacequipset_cbtshirt", "dsg_eep_tacequipset_cbtshirt"), new Attribute("dsg_eep_tacequipset_enf_cbtshirt", "dsg_eep_tacequipset_enf_cbtshirt"), new Attribute("dsg_eep_tacequipset_enf_sslcbtshirt", "dsg_eep_tacequipset_enf_sslcbtshirt"), new Attribute("dsg_eep_tacequipset_sslcbtshirt", "dsg_eep_tacequipset_sslcbtshirt"), new Attribute("dsg_hlf_equip_rtunic", "dsg_hlf_equip_rtunic"), new Attribute("innoxia_butler_butler_waistcoat_shirt", "innoxia_butler_butler_waistcoat_shirt"), new Attribute("innoxia_japanese_kimono", "innoxia_japanese_kimono"), new Attribute("innoxia_japanese_kimono_short", "innoxia_japanese_kimono_short"), new Attribute("innoxia_japanese_mens_kimono", "innoxia_japanese_mens_kimono"), new Attribute("innoxia_maid_dress", "innoxia_maid_dress"), new Attribute("innoxia_torso_blouse", "innoxia_torso_blouse"), new Attribute("innoxia_torso_feminine_short_sleeve_shirt", "innoxia_torso_feminine_short_sleeve_shirt"), new Attribute("innoxia_torso_long_sleeved_shirt", "innoxia_torso_long_sleeved_shirt"), new Attribute("innoxia_torso_peplos", "innoxia_torso_peplos"), new Attribute("innoxia_torso_plunge_blouse", "innoxia_torso_plunge_blouse"), new Attribute("innoxia_torso_plunge_club_dress", "innoxia_torso_plunge_club_dress"), new Attribute("innoxia_torso_short_sleeved_shirt", "innoxia_torso_short_sleeved_shirt"), new Attribute("innoxia_torso_tshirt", "innoxia_torso_tshirt"), new Attribute("innoxia_torso_tshirt_test_item", "innoxia_torso_tshirt_test_item"), new Attribute("innoxia_witch_witch_dress", "innoxia_witch_witch_dress"), new Attribute("phlarx_dresses_ballgown", "phlarx_dresses_ballgown"), new Attribute("phlarx_dresses_evening_gown", "phlarx_dresses_evening_gown"), new Attribute("phlarx_dresses_rockabilly_dress", "phlarx_dresses_rockabilly_dress"), new Attribute("phlarx_dresses_vintage_dress", "phlarx_dresses_vintage_dress"), new Attribute("rfpnj_slavery_administration_shirt", "rfpnj_slavery_administration_shirt"), new Attribute("sage_latex_croptop", "sage_latex_croptop"), new Attribute("TonyJC_cropped_tshirt", "TonyJC_cropped_tshirt"), new Attribute("TonyJC_crop_tank_top", "TonyJC_crop_tank_top"), new Attribute("TonyJC_one_strap_crop_tank_top", "TonyJC_one_strap_crop_tank_top"), new Attribute("TonyJC_sleeveless_shirt", "TonyJC_sleeveless_shirt"), new Attribute("TonyJC_spaghetti_crop_tank_top", "TonyJC_spaghetti_crop_tank_top"), new Attribute("TonyJC_tank_top", "TonyJC_tank_top"), new Attribute("TonyJC_tie_up_crop_top", "TonyJC_tie_up_crop_top")});
        clothesMap.put(ClothingType.HAND, new Attribute[]{new Attribute("c4mg1rl_benevolent_mitsugake", "c4mg1rl_benevolent_mitsugake"), new Attribute("dsg_ckls_ckls_gloves", "dsg_ckls_ckls_gloves"), new Attribute("innoxia_butler_butler_gloves", "innoxia_butler_butler_gloves"), new Attribute("innoxia_hand_elbow_length_gloves", "innoxia_hand_elbow_length_gloves"), new Attribute("innoxia_hand_fingerless_gloves", "innoxia_hand_fingerless_gloves"), new Attribute("innoxia_hand_fishnet_gloves", "innoxia_hand_fishnet_gloves"), new Attribute("innoxia_hand_gloves", "innoxia_hand_gloves"), new Attribute("innoxia_hand_striped_gloves", "innoxia_hand_striped_gloves"), new Attribute("innoxia_hand_wraps", "innoxia_hand_wraps"), new Attribute("innoxia_maid_sleeves", "innoxia_maid_sleeves"), new Attribute("innoxia_rainbow_gloves", "innoxia_rainbow_gloves"), new Attribute("sage_latex_arm_warmers", "sage_latex_arm_warmers"), new Attribute("sage_latex_elbow_gloves", "sage_latex_elbow_gloves")});
        clothesMap.put(ClothingType.NECK, new Attribute[]{new Attribute("c4mg1rl_benevolent_necklace", "c4mg1rl_benevolent_necklace"), new Attribute("c4mg1rl_trickster_cloak", "c4mg1rl_trickster_cloak"), new Attribute("dsg_eep_riotarmorset_riotneckprotector", "dsg_eep_riotarmorset_riotneckprotector"), new Attribute("dsg_foxscarf_foxscarf", "dsg_foxscarf_foxscarf"), new Attribute("innoxia_bdsm_choker", "innoxia_bdsm_choker"), new Attribute("innoxia_bdsm_metal_collar", "innoxia_bdsm_metal_collar"), new Attribute("innoxia_cattle_cowbell_collar", "innoxia_cattle_cowbell_collar"), new Attribute("innoxia_darkSiren_siren_amulet", "innoxia_darkSiren_siren_amulet"), new Attribute("innoxia_darkSiren_siren_cloak", "innoxia_darkSiren_siren_cloak"), new Attribute("innoxia_elemental_snowflake_necklace", "innoxia_elemental_snowflake_necklace"), new Attribute("innoxia_elemental_sun_necklace", "innoxia_elemental_sun_necklace"), new Attribute("innoxia_mouth_bandana", "innoxia_mouth_bandana"), new Attribute("innoxia_neck_ambers_bitch_collar", "innoxia_neck_ambers_bitch_collar"), new Attribute("innoxia_neck_ankh_necklace", "innoxia_neck_ankh_necklace"), new Attribute("innoxia_neck_bell_collar", "innoxia_neck_bell_collar"), new Attribute("innoxia_neck_breeder_collar", "innoxia_neck_breeder_collar"), new Attribute("innoxia_neck_collar_bowtie", "innoxia_neck_collar_bowtie"), new Attribute("innoxia_neck_demonstone_necklace", "innoxia_neck_demonstone_necklace"), new Attribute("innoxia_neck_diamond_necklace", "innoxia_neck_diamond_necklace"), new Attribute("innoxia_neck_filly_choker", "innoxia_neck_filly_choker"), new Attribute("innoxia_neck_gemstone_necklace", "innoxia_neck_gemstone_necklace"), new Attribute("innoxia_neck_heart_necklace", "innoxia_neck_heart_necklace"), new Attribute("innoxia_neck_horseshoe_necklace", "innoxia_neck_horseshoe_necklace"), new Attribute("innoxia_neck_key_chain", "innoxia_neck_key_chain"), new Attribute("innoxia_neck_scarf", "innoxia_neck_scarf"), new Attribute("innoxia_neck_tie", "innoxia_neck_tie"), new Attribute("innoxia_neck_velvet_choker", "innoxia_neck_velvet_choker"), new Attribute("innoxia_torsoOver_fur_cloak", "innoxia_torsoOver_fur_cloak"), new Attribute("irbynx_spikedCollar_punk_neck_metal_collar_spiked", "irbynx_spikedCollar_punk_neck_metal_collar_spiked")});
        clothesMap.put(ClothingType.WRIST, new Attribute[]{new Attribute("c4mg1rl_benevolent_necklace", "c4mg1rl_benevolent_necklace"), new Attribute("dsg_eep_riotarmorset_riotarmguards", "dsg_eep_riotarmorset_riotarmguards"), new Attribute("dsg_eep_tacequipset_telbowpads", "dsg_eep_tacequipset_telbowpads"), new Attribute("dsg_hlf_equip_rbrassard", "dsg_hlf_equip_rbrassard"), new Attribute("dsg_hndcuffs_hndcuffs", "dsg_hndcuffs_hndcuffs"), new Attribute("innoxia_bdsm_wrist_bracelets", "innoxia_bdsm_wrist_bracelets"), new Attribute("innoxia_bdsm_wrist_restraints", "innoxia_bdsm_wrist_restraints"), new Attribute("innoxia_elemental_snowflake_necklace", "innoxia_elemental_snowflake_necklace"), new Attribute("innoxia_elemental_sun_necklace", "innoxia_elemental_sun_necklace"), new Attribute("innoxia_neck_ankh_necklace", "innoxia_neck_ankh_necklace"), new Attribute("innoxia_neck_demonstone_necklace", "innoxia_neck_demonstone_necklace"), new Attribute("innoxia_neck_gemstone_necklace", "innoxia_neck_gemstone_necklace"), new Attribute("innoxia_neck_heart_necklace", "innoxia_neck_heart_necklace"), new Attribute("innoxia_neck_horseshoe_necklace", "innoxia_neck_horseshoe_necklace"), new Attribute("innoxia_neck_key_chain", "innoxia_neck_key_chain"), new Attribute("innoxia_wrist_thin_bangles", "innoxia_wrist_thin_bangles"), new Attribute("nerdlinger_rollerskating_elbowpads_rollerskating_elbowpads", "nerdlinger_rollerskating_elbowpads_rollerskating_elbowpads"), new Attribute("norin_hair_accessories_hair_scrunchie", "norin_hair_accessories_hair_scrunchie"), new Attribute("sage_latex_arm_warmers", "sage_latex_arm_warmers")});
        clothesMap.put(ClothingType.STOMACH, new Attribute[]{new Attribute("c4mg1rl_strapless_bodysuit_strapless_bodysuit", "c4mg1rl_strapless_bodysuit_strapless_bodysuit"), new Attribute("innoxia_bdsm_karada", "innoxia_bdsm_karada"), new Attribute("innoxia_milking_breast_pumps", "innoxia_milking_breast_pumps"), new Attribute("innoxia_stomach_lowback_body", "innoxia_stomach_lowback_body"), new Attribute("innoxia_stomach_overbust_corset", "innoxia_stomach_overbust_corset"), new Attribute("innoxia_stomach_sarashi", "innoxia_stomach_sarashi"), new Attribute("innoxia_stomach_underbust_corset", "innoxia_stomach_underbust_corset"), new Attribute("sage_latex_bodysuit", "sage_latex_bodysuit"), new Attribute("sage_latex_corset", "sage_latex_corset")});
        clothesMap.put(ClothingType.EYES, new Attribute[]{new Attribute("c4mg1rl_trickster_mask", "c4mg1rl_trickster_mask"), new Attribute("dsg_eep_tacequipset_bglasses", "dsg_eep_tacequipset_bglasses"), new Attribute("dsg_eep_tacequipset_bgoggles", "dsg_eep_tacequipset_bgoggles"), new Attribute("dsg_eep_tacequipset_nvgoggles", "dsg_eep_tacequipset_nvgoggles"), new Attribute("innoxia_bdsm_blindfold", "innoxia_bdsm_blindfold"), new Attribute("innoxia_darkSiren_siren_seal", "innoxia_darkSiren_siren_seal"), new Attribute("innoxia_eye_aviators", "innoxia_eye_aviators"), new Attribute("innoxia_eye_glasses", "innoxia_eye_glasses"), new Attribute("innoxia_eye_half_moon_glasses", "innoxia_eye_half_moon_glasses"), new Attribute("innoxia_eye_half_rim_glasses", "innoxia_eye_half_rim_glasses"), new Attribute("innoxia_eye_patch", "innoxia_eye_patch"), new Attribute("innoxia_eye_safety_glasses", "innoxia_eye_safety_glasses"), new Attribute("innoxia_eye_thick_rim_glasses", "innoxia_eye_thick_rim_glasses"), new Attribute("innoxia_scientist_safety_goggles", "innoxia_scientist_safety_goggles"), new Attribute("nerdlinger_sports_noseguard_transparent_noseguard", "nerdlinger_sports_noseguard_transparent_noseguard"), new Attribute("phlarx_sunglasses_cat_eye_sunglasses", "phlarx_sunglasses_cat_eye_sunglasses"), new Attribute("phlarx_sunglasses_heart_sunglasses", "phlarx_sunglasses_heart_sunglasses"), new Attribute("phlarx_sunglasses_round_sunglasses", "phlarx_sunglasses_round_sunglasses")});
        clothesMap.put(ClothingType.SOCK, new Attribute[]{new Attribute("corpseBloom_toeless_stockings_toeless_stockings", "corpseBloom_toeless_stockings_toeless_stockings"), new Attribute("dsg_ckls_ckls_stockings", "dsg_ckls_ckls_stockings"), new Attribute("innoxia_maid_stockings", "innoxia_maid_stockings"), new Attribute("innoxia_rainbow_stockings", "innoxia_rainbow_stockings"), new Attribute("innoxia_sock_fishnets", "innoxia_sock_fishnets"), new Attribute("innoxia_sock_kneehigh_socks", "innoxia_sock_kneehigh_socks"), new Attribute("innoxia_sock_pantyhose", "innoxia_sock_pantyhose"), new Attribute("innoxia_sock_socks", "innoxia_sock_socks"), new Attribute("innoxia_sock_stockings", "innoxia_sock_stockings"), new Attribute("innoxia_sock_thighhigh_socks", "innoxia_sock_thighhigh_socks"), new Attribute("innoxia_sock_thighhigh_socks_striped", "innoxia_sock_thighhigh_socks_striped"), new Attribute("innoxia_sock_toeless_striped_stockings", "innoxia_sock_toeless_striped_stockings"), new Attribute("innoxia_sock_trainer_socks", "innoxia_sock_trainer_socks"), new Attribute("nerdlinger_ronin_tabi_tabi", "nerdlinger_ronin_tabi_tabi"), new Attribute("sage_latex_stockings", "sage_latex_stockings"), new Attribute("sage_latex_stockings_open", "sage_latex_stockings_open")});
        clothesMap.put(ClothingType.HEAD, new Attribute[]{new Attribute("dsg_bheadband_bheadband", "dsg_bheadband_bheadband"), new Attribute("dsg_ckls_ckls_headband", "dsg_ckls_ckls_headband"), new Attribute("dsg_eep_ptrlequipset_bwhat", "dsg_eep_ptrlequipset_bwhat"), new Attribute("dsg_eep_ptrlequipset_pcap", "dsg_eep_ptrlequipset_pcap"), new Attribute("dsg_eep_riotarmorset_riothelmet", "dsg_eep_riotarmorset_riothelmet"), new Attribute("dsg_eep_servequipset_debuggerydo_enfberet", "dsg_eep_servequipset_debuggerydo_enfberet"), new Attribute("dsg_eep_servequipset_enfberet", "dsg_eep_servequipset_enfberet"), new Attribute("dsg_eep_tacequipset_chelmet", "dsg_eep_tacequipset_chelmet"), new Attribute("dsg_hlf_equip_rbooniehat", "dsg_hlf_equip_rbooniehat"), new Attribute("innoxia_head_antler_headband", "innoxia_head_antler_headband"), new Attribute("innoxia_head_cap", "innoxia_head_cap"), new Attribute("innoxia_head_circlet", "innoxia_head_circlet"), new Attribute("innoxia_head_cowboy_hat", "innoxia_head_cowboy_hat"), new Attribute("innoxia_head_hard_hat", "innoxia_head_hard_hat"), new Attribute("innoxia_head_headband", "innoxia_head_headband"), new Attribute("innoxia_head_headband_bow", "innoxia_head_headband_bow"), new Attribute("innoxia_head_jack_o_lantern", "innoxia_head_jack_o_lantern"), new Attribute("innoxia_head_slime_queens_tiara", "innoxia_head_slime_queens_tiara"), new Attribute("innoxia_head_sweatband", "innoxia_head_sweatband"), new Attribute("innoxia_head_tiara", "innoxia_head_tiara"), new Attribute("innoxia_impArcanist_arcanist_hat", "innoxia_impArcanist_arcanist_hat"), new Attribute("innoxia_lyssiethUniform_hat", "innoxia_lyssiethUniform_hat"), new Attribute("innoxia_maid_headpiece", "innoxia_maid_headpiece"), new Attribute("innoxia_mouth_bandana", "innoxia_mouth_bandana"), new Attribute("innoxia_witch_witch_hat", "innoxia_witch_witch_hat"), new Attribute("innoxia_witch_witch_hat_wide", "innoxia_witch_witch_hat_wide"), new Attribute("nerdlinger_rollerskating_helmet_rollerskating_helmet", "nerdlinger_rollerskating_helmet_rollerskating_helmet"), new Attribute("nerdlinger_sports_biking_helmet_biking_helmet", "nerdlinger_sports_biking_helmet_biking_helmet")});
        clothesMap.put(ClothingType.CHEST, new Attribute[]{new Attribute("dsg_ckls_ckls_bra", "dsg_ckls_ckls_bra"), new Attribute("innoxia_chest_lacy_plunge_bra", "innoxia_chest_lacy_plunge_bra"), new Attribute("innoxia_chest_strapless_bra", "innoxia_chest_strapless_bra"), new Attribute("innoxia_loinCloth_ragged_chest_wrap", "innoxia_loinCloth_ragged_chest_wrap"), new Attribute("sage_latex_bra", "sage_latex_bra")});
        clothesMap.put(ClothingType.GROIN, new Attribute[]{new Attribute("dsg_ckls_ckls_panties", "dsg_ckls_ckls_panties"), new Attribute("innoxia_bdsm_chastity_belt", "innoxia_bdsm_chastity_belt"), new Attribute("innoxia_bdsm_chastity_belt_full", "innoxia_bdsm_chastity_belt_full"), new Attribute("innoxia_groin_backless_panties", "innoxia_groin_backless_panties"), new Attribute("innoxia_groin_bikini", "innoxia_groin_bikini"), new Attribute("innoxia_groin_boxers", "innoxia_groin_boxers"), new Attribute("innoxia_groin_boyshorts", "innoxia_groin_boyshorts"), new Attribute("innoxia_groin_briefs", "innoxia_groin_briefs"), new Attribute("innoxia_groin_crotchless_briefs", "innoxia_groin_crotchless_briefs"), new Attribute("innoxia_groin_crotchless_panties", "innoxia_groin_crotchless_panties"), new Attribute("innoxia_groin_crotchless_thong", "innoxia_groin_crotchless_thong"), new Attribute("innoxia_groin_jockstrap", "innoxia_groin_jockstrap"), new Attribute("innoxia_groin_lacy_panties", "innoxia_groin_lacy_panties"), new Attribute("innoxia_groin_lacy_thong", "innoxia_groin_lacy_thong"), new Attribute("innoxia_groin_panties", "innoxia_groin_panties"), new Attribute("innoxia_groin_shimapan", "innoxia_groin_shimapan"), new Attribute("innoxia_groin_thong", "innoxia_groin_thong"), new Attribute("innoxia_groin_vstring", "innoxia_groin_vstring"), new Attribute("sage_latex_panties", "sage_latex_panties")});
        clothesMap.put(ClothingType.LEG, new Attribute[]{new Attribute("dsg_eep_ptrlequipset_enfslacks", "dsg_eep_ptrlequipset_enfslacks"), new Attribute("dsg_eep_servequipset_enfdslacks", "dsg_eep_servequipset_enfdslacks"), new Attribute("dsg_eep_servequipset_enfskirt", "dsg_eep_servequipset_enfskirt"), new Attribute("dsg_eep_tacequipset_tpants", "dsg_eep_tacequipset_tpants"), new Attribute("dsg_hlf_equip_rtrousers", "dsg_hlf_equip_rtrousers"), new Attribute("innoxia_butler_butler_trousers", "innoxia_butler_butler_trousers"), new Attribute("innoxia_leg_assless_chaps", "innoxia_leg_assless_chaps"), new Attribute("innoxia_leg_asymmetrical_skirt", "innoxia_leg_asymmetrical_skirt"), new Attribute("innoxia_leg_bike_shorts", "innoxia_leg_bike_shorts"), new Attribute("innoxia_leg_cargo_trousers", "innoxia_leg_cargo_trousers"), new Attribute("innoxia_leg_crotchless_chaps", "innoxia_leg_crotchless_chaps"), new Attribute("innoxia_leg_distressed_jeans", "innoxia_leg_distressed_jeans"), new Attribute("innoxia_leg_hotpants", "innoxia_leg_hotpants"), new Attribute("innoxia_leg_jeans", "innoxia_leg_jeans"), new Attribute("innoxia_leg_mens_hakama", "innoxia_leg_mens_hakama"), new Attribute("innoxia_leg_micro_skirt_belted", "innoxia_leg_micro_skirt_belted"), new Attribute("innoxia_leg_micro_skirt_pleated", "innoxia_leg_micro_skirt_pleated"), new Attribute("innoxia_leg_mini_skirt", "innoxia_leg_mini_skirt"), new Attribute("innoxia_leg_pencil_skirt", "innoxia_leg_pencil_skirt"), new Attribute("innoxia_leg_shorts", "innoxia_leg_shorts"), new Attribute("innoxia_leg_skirt", "innoxia_leg_skirt"), new Attribute("innoxia_leg_sport_shorts", "innoxia_leg_sport_shorts"), new Attribute("innoxia_leg_taur_skirt", "innoxia_leg_taur_skirt"), new Attribute("innoxia_leg_taur_trousers", "innoxia_leg_taur_trousers"), new Attribute("innoxia_leg_tight_jeans", "innoxia_leg_tight_jeans"), new Attribute("innoxia_leg_trousers", "innoxia_leg_trousers"), new Attribute("innoxia_leg_trousers_women", "innoxia_leg_trousers_women"), new Attribute("innoxia_leg_yoga_pants", "innoxia_leg_yoga_pants"), new Attribute("innoxia_loinCloth_loin_cloth", "innoxia_loinCloth_loin_cloth"), new Attribute("innoxia_loinCloth_ragged_skirt", "innoxia_loinCloth_ragged_skirt"), new Attribute("innoxia_lyssiethUniform_skirt", "innoxia_lyssiethUniform_skirt"), new Attribute("nerdlinger_street_joggers_joggers", "nerdlinger_street_joggers_joggers"), new Attribute("sage_latex_latexleggings", "sage_latex_latexleggings"), new Attribute("TonyJC_daisy_dukes", "TonyJC_daisy_dukes"), new Attribute("TonyJC_denim_overalls", "TonyJC_denim_overalls")});
        clothesMap.put(ClothingType.HIPS, new Attribute[]{new Attribute("dsg_eep_ptrlequipset_utilbelt", "dsg_eep_ptrlequipset_utilbelt"), new Attribute("dsg_eep_riotarmorset_riotbelt", "dsg_eep_riotarmorset_riotbelt"), new Attribute("dsg_eep_servequipset_enfdbelt", "dsg_eep_servequipset_enfdbelt"), new Attribute("dsg_eep_servequipset_enfstbelt", "dsg_eep_servequipset_enfstbelt"), new Attribute("dsg_eep_tacequipset_battlebelt", "dsg_eep_tacequipset_battlebelt"), new Attribute("dsg_eep_tacequipset_hbattlebelt", "dsg_eep_tacequipset_hbattlebelt"), new Attribute("innoxia_hips_leather_belt", "innoxia_hips_leather_belt")});
        clothesMap.put(ClothingType.ANKLE, new Attribute[]{new Attribute("dsg_eep_riotarmorset_riotshinguards", "dsg_eep_riotarmorset_riotshinguards"), new Attribute("dsg_eep_tacequipset_tkneepads", "dsg_eep_tacequipset_tkneepads"), new Attribute("innoxia_ankle_anklet", "innoxia_ankle_anklet"), new Attribute("innoxia_ankle_shin_guards", "innoxia_ankle_shin_guards"), new Attribute("innoxia_bdsm_spreaderbar", "innoxia_bdsm_spreaderbar"), new Attribute("innoxia_bdsm_wrist_bracelets", "innoxia_bdsm_wrist_bracelets"), new Attribute("innoxia_bdsm_wrist_restraints", "innoxia_bdsm_wrist_restraints"), new Attribute("nerdlinger_rollerskating_kneepads_rollerskating_kneepads", "nerdlinger_rollerskating_kneepads_rollerskating_kneepads")});
        clothesMap.put(ClothingType.FOOT, new Attribute[]{new Attribute("dsg_eep_servequipset_enfjackboots", "dsg_eep_servequipset_enfjackboots"), new Attribute("dsg_eep_servequipset_enfpumps", "dsg_eep_servequipset_enfpumps"), new Attribute("dsg_eep_tacequipset_cboots", "dsg_eep_tacequipset_cboots"), new Attribute("dsg_hlf_equip_vcboots", "dsg_hlf_equip_vcboots"), new Attribute("innoxia_butler_butler_shoes", "innoxia_butler_butler_shoes"), new Attribute("innoxia_foot_ankle_boots", "innoxia_foot_ankle_boots"), new Attribute("innoxia_foot_chelsea_boots", "innoxia_foot_chelsea_boots"), new Attribute("innoxia_foot_flats", "innoxia_foot_flats"), new Attribute("innoxia_foot_gladiator_sandals", "innoxia_foot_gladiator_sandals"), new Attribute("innoxia_foot_goth_boots_fem", "innoxia_foot_goth_boots_fem"), new Attribute("innoxia_foot_heels", "innoxia_foot_heels"), new Attribute("innoxia_foot_low_top_skater_shoes", "innoxia_foot_low_top_skater_shoes"), new Attribute("innoxia_foot_mens_smart_shoes", "innoxia_foot_mens_smart_shoes"), new Attribute("innoxia_foot_platform_boots", "innoxia_foot_platform_boots"), new Attribute("innoxia_foot_stiletto_heels", "innoxia_foot_stiletto_heels"), new Attribute("innoxia_foot_strappy_sandals", "innoxia_foot_strappy_sandals"), new Attribute("innoxia_foot_thigh_high_boots", "innoxia_foot_thigh_high_boots"), new Attribute("innoxia_foot_trainers", "innoxia_foot_trainers"), new Attribute("innoxia_foot_work_boots", "innoxia_foot_work_boots"), new Attribute("innoxia_japanese_geta", "innoxia_japanese_geta"), new Attribute("innoxia_japanese_mens_geta", "innoxia_japanese_mens_geta"), new Attribute("innoxia_loinCloth_foot_wraps", "innoxia_loinCloth_foot_wraps"), new Attribute("innoxia_lyssiethUniform_shoes", "innoxia_lyssiethUniform_shoes"), new Attribute("innoxia_maid_heels", "innoxia_maid_heels"), new Attribute("innoxia_witch_witch_boots", "innoxia_witch_witch_boots"), new Attribute("innoxia_witch_witch_boots_thigh_high", "innoxia_witch_witch_boots_thigh_high"), new Attribute("nerdlinger_street_hitop_canvas_sneakers_hi_top_canvas_sneakers", "nerdlinger_street_hitop_canvas_sneakers_hi_top_canvas_sneakers")});
        clothesMap.put(ClothingType.MOUTH, new Attribute[]{new Attribute("dsg_eep_tacequipset_gmask", "dsg_eep_tacequipset_gmask"), new Attribute("dsg_hlf_equip_sbandana", "dsg_hlf_equip_sbandana"), new Attribute("innoxia_anus_ribbed_dildo", "innoxia_anus_ribbed_dildo"), new Attribute("innoxia_bdsm_ballgag", "innoxia_bdsm_ballgag"), new Attribute("innoxia_bdsm_ringgag", "innoxia_bdsm_ringgag"), new Attribute("innoxia_mouth_bandana", "innoxia_mouth_bandana"), new Attribute("innoxia_webbing_seal_mouth", "innoxia_webbing_seal_mouth"), new Attribute("norin_dildos_realistic_dildo", "norin_dildos_realistic_dildo")});
        clothesMap.put(ClothingType.ANUS, new Attribute[]{new Attribute("innoxia_anus_ribbed_dildo", "innoxia_anus_ribbed_dildo"), new Attribute("innoxia_buttPlugs_butt_plug", "innoxia_buttPlugs_butt_plug"), new Attribute("innoxia_buttPlugs_butt_plug_heart", "innoxia_buttPlugs_butt_plug_heart"), new Attribute("innoxia_buttPlugs_butt_plug_jewel", "innoxia_buttPlugs_butt_plug_jewel"), new Attribute("innoxia_buttPlugs_butt_plug_tail", "innoxia_buttPlugs_butt_plug_tail"), new Attribute("innoxia_webbing_seal_anus", "innoxia_webbing_seal_anus"), new Attribute("norin_anal_beads_anal_beads", "norin_anal_beads_anal_beads"), new Attribute("norin_dildos_realistic_dildo", "norin_dildos_realistic_dildo")});
        clothesMap.put(ClothingType.VAGINA, new Attribute[]{new Attribute("innoxia_anus_ribbed_dildo", "innoxia_anus_ribbed_dildo"), new Attribute("innoxia_milking_vagina_pump", "innoxia_milking_vagina_pump"), new Attribute("innoxia_vagina_insertable_dildo", "innoxia_vagina_insertable_dildo"), new Attribute("innoxia_vagina_sticker_anal_only", "innoxia_vagina_sticker_anal_only"), new Attribute("innoxia_webbing_seal_vagina", "innoxia_webbing_seal_vagina"), new Attribute("norin_clover_clamps_clover_clamps", "norin_clover_clamps_clover_clamps"), new Attribute("norin_dildos_realistic_dildo", "norin_dildos_realistic_dildo"), new Attribute("norin_strapless_dildo_strapless_dildo", "norin_strapless_dildo_strapless_dildo")});
        clothesMap.put(ClothingType.PENIS, new Attribute[]{new Attribute("innoxia_bdsm_chastity_cage", "innoxia_bdsm_chastity_cage"), new Attribute("innoxia_bdsm_ornate_chastity_cage", "innoxia_bdsm_ornate_chastity_cage"), new Attribute("innoxia_bdsm_penis_strapon", "innoxia_bdsm_penis_strapon"), new Attribute("innoxia_milking_penis_pump", "innoxia_milking_penis_pump"), new Attribute("innoxia_penis_condom", "innoxia_penis_condom"), new Attribute("innoxia_penis_condom_strong", "innoxia_penis_condom_strong"), new Attribute("innoxia_penis_condom_super_strong", "innoxia_penis_condom_super_strong"), new Attribute("innoxia_penis_condom_webbing", "innoxia_penis_condom_webbing")});
        clothesMap.put(ClothingType.PIERCING_EAR, new Attribute[]{new Attribute("innoxia_cattle_piercing_ear_tag", "innoxia_cattle_piercing_ear_tag"), new Attribute("innoxia_elemental_piercing_ear_snowflakes", "innoxia_elemental_piercing_ear_snowflakes"), new Attribute("innoxia_elemental_piercing_ear_sun", "innoxia_elemental_piercing_ear_sun"), new Attribute("innoxia_piercing_basic_barbell", "innoxia_piercing_basic_barbell"), new Attribute("innoxia_piercing_basic_barbell_pair", "innoxia_piercing_basic_barbell_pair"), new Attribute("innoxia_piercing_ear_ball_studs", "innoxia_piercing_ear_ball_studs"), new Attribute("innoxia_piercing_ear_chain_dangle", "innoxia_piercing_ear_chain_dangle"), new Attribute("innoxia_piercing_ear_cuff_chains", "innoxia_piercing_ear_cuff_chains"), new Attribute("innoxia_piercing_ear_hoops", "innoxia_piercing_ear_hoops"), new Attribute("innoxia_piercing_ear_pearl_studs", "innoxia_piercing_ear_pearl_studs"), new Attribute("innoxia_piercing_ear_ring", "innoxia_piercing_ear_ring"), new Attribute("innoxia_quest_dairy_ear_tag", "innoxia_quest_dairy_ear_tag"), new Attribute("innoxia_quest_dairy_ear_tag_npc", "innoxia_quest_dairy_ear_tag_npc"), new Attribute("norin_piercings_piercing_ear_bats", "norin_piercings_piercing_ear_bats"), new Attribute("norin_rose_piercings_piercing_ear_rose", "norin_rose_piercings_piercing_ear_rose"), new Attribute("norin_sunflower_piercings_piercing_ear_sunflower", "norin_sunflower_piercings_piercing_ear_sunflower")});
        clothesMap.put(ClothingType.PIERCING_NOSE, new Attribute[]{new Attribute("innoxia_cattle_piercing_nose_ring", "innoxia_cattle_piercing_nose_ring"), new Attribute("innoxia_elemental_piercing_nose_snowflake", "innoxia_elemental_piercing_nose_snowflake"), new Attribute("innoxia_elemental_piercing_nose_sun", "innoxia_elemental_piercing_nose_sun"), new Attribute("innoxia_piercing_nose_ball_stud", "innoxia_piercing_nose_ball_stud"), new Attribute("innoxia_piercing_nose_ring", "innoxia_piercing_nose_ring"), new Attribute("norin_rose_piercings_piercing_nose_rose", "norin_rose_piercings_piercing_nose_rose"), new Attribute("norin_sunflower_piercings_piercing_nose_sunflower", "norin_sunflower_piercings_piercing_nose_sunflower")});
        clothesMap.put(ClothingType.FINGER, new Attribute[]{new Attribute("innoxia_finger_gemstone_ring", "innoxia_finger_gemstone_ring"), new Attribute("innoxia_finger_gemstone_ring_unisex", "innoxia_finger_gemstone_ring_unisex"), new Attribute("innoxia_finger_lips_ring", "innoxia_finger_lips_ring"), new Attribute("innoxia_finger_meander_ring", "innoxia_finger_meander_ring"), new Attribute("innoxia_finger_ring", "innoxia_finger_ring"), new Attribute("innoxia_finger_wrap_ring", "innoxia_finger_wrap_ring")});
        clothesMap.put(ClothingType.HAIR, new Attribute[]{new Attribute("innoxia_hair_rose", "innoxia_hair_rose"), new Attribute("innoxia_japanese_kanzashi", "innoxia_japanese_kanzashi"), new Attribute("innoxia_mouth_bandana", "innoxia_mouth_bandana"), new Attribute("norin_hair_accessories_hair_bobby_pins", "norin_hair_accessories_hair_bobby_pins"), new Attribute("norin_hair_accessories_hair_celtic_barrette", "norin_hair_accessories_hair_celtic_barrette"), new Attribute("norin_hair_accessories_hair_dragonfly", "norin_hair_accessories_hair_dragonfly"), new Attribute("norin_hair_accessories_hair_pins", "norin_hair_accessories_hair_pins"), new Attribute("norin_hair_accessories_hair_scrunchie", "norin_hair_accessories_hair_scrunchie"), new Attribute("norin_hair_accessories_hair_sticks", "norin_hair_accessories_hair_sticks"), new Attribute("norin_tail_ribbon_tail_ribbon", "norin_tail_ribbon_tail_ribbon")});
        clothesMap.put(ClothingType.HORNS, new Attribute[]{new Attribute("innoxia_horn_ring_chain", "innoxia_horn_ring_chain"), new Attribute("innoxia_horn_thin_rings", "innoxia_horn_thin_rings")});
        clothesMap.put(ClothingType.NIPPLE, new Attribute[]{new Attribute("innoxia_milking_breast_pumps", "innoxia_milking_breast_pumps"), new Attribute("innoxia_webbing_seal_nipples", "innoxia_webbing_seal_nipples"), new Attribute("norin_clover_clamps_clover_clamps", "norin_clover_clamps_clover_clamps")});
        clothesMap.put(ClothingType.PIERCING_TONGUE, new Attribute[]{new Attribute("innoxia_piercing_basic_barbell", "innoxia_piercing_basic_barbell")});
        clothesMap.put(ClothingType.PIERCING_NIPPLE, new Attribute[]{new Attribute("innoxia_piercing_basic_barbell_pair", "innoxia_piercing_basic_barbell_pair"), new Attribute("innoxia_piercing_nipple_chain", "innoxia_piercing_nipple_chain"), new Attribute("norin_piercings_bat_wings_barbells", "norin_piercings_bat_wings_barbells"), new Attribute("norin_piercings_heart_barbells", "norin_piercings_heart_barbells"), new Attribute("norin_piercings_piercing_nipple_chain", "norin_piercings_piercing_nipple_chain"), new Attribute("norin_piercings_piercing_nipple_rings", "norin_piercings_piercing_nipple_rings")});
        clothesMap.put(ClothingType.PIERCING_STOMACH, new Attribute[]{new Attribute("innoxia_piercing_gemstone_barbell", "innoxia_piercing_gemstone_barbell"), new Attribute("innoxia_piercing_ringed_barbell", "innoxia_piercing_ringed_barbell"), new Attribute("norin_piercings_caution_when_wet", "norin_piercings_caution_when_wet"), new Attribute("norin_piercings_piercing_pentagram_navel", "norin_piercings_piercing_pentagram_navel"), new Attribute("norin_rose_piercings_piercing_navel_rose", "norin_rose_piercings_piercing_navel_rose"), new Attribute("norin_sunflower_piercings_piercing_sunflower_navel", "norin_sunflower_piercings_piercing_sunflower_navel")});
        clothesMap.put(ClothingType.PIERCING_VAGINA, new Attribute[]{new Attribute("innoxia_piercing_gemstone_barbell", "innoxia_piercing_gemstone_barbell"), new Attribute("innoxia_piercing_ringed_barbell", "innoxia_piercing_ringed_barbell"), new Attribute("norin_piercings_heart_clit", "norin_piercings_heart_clit"), new Attribute("norin_piercings_piercing_vagina_sex", "norin_piercings_piercing_vagina_sex"), new Attribute("norin_piercings_piercing_vertical_hood", "norin_piercings_piercing_vertical_hood")});
        clothesMap.put(ClothingType.PIERCING_LIP, new Attribute[]{new Attribute("innoxia_piercing_lip_double_ring", "innoxia_piercing_lip_double_ring"), new Attribute("norin_piercings_piercing_lip_flower", "norin_piercings_piercing_lip_flower"), new Attribute("norin_rose_piercings_piercing_lip_rose", "norin_rose_piercings_piercing_lip_rose"), new Attribute("norin_sunflower_piercings_piercing_lip_sunflower", "norin_sunflower_piercings_piercing_lip_sunflower")});
        clothesMap.put(ClothingType.PIERCING_PENIS, new Attribute[]{new Attribute("innoxia_piercing_penis_ring", "innoxia_piercing_penis_ring")});
        clothesMap.put(ClothingType.TAIL, new Attribute[]{new Attribute("norin_hair_accessories_hair_scrunchie", "norin_hair_accessories_hair_scrunchie"), new Attribute("norin_tail_ribbon_tail_ribbon", "norin_tail_ribbon_tail_ribbon")});

        // endregion

        // region Items Initialization

        itemsMap.put(ItemType.ITEM, new Attribute[]{new Attribute("charisma_race_spider_chocolate_coated_cocoa_beans", "charisma_race_spider_chocolate_coated_cocoa_beans"), new Attribute("charisma_race_spider_jet_black_coffee", "charisma_race_spider_jet_black_coffee"), new Attribute("dsg_quest_hazmat_rat_card", "dsg_quest_hazmat_rat_card"), new Attribute("dsg_race_bear_honey_bread", "dsg_race_bear_honey_bread"), new Attribute("dsg_race_bear_vodka", "dsg_race_bear_vodka"), new Attribute("dsg_race_dragon_draft_green", "dsg_race_dragon_draft_green"), new Attribute("dsg_race_dragon_draft_orange", "dsg_race_dragon_draft_orange"), new Attribute("dsg_race_dragon_draft_pink", "dsg_race_dragon_draft_pink"), new Attribute("dsg_race_dragon_dragonfruit_pink", "dsg_race_dragon_dragonfruit_pink"), new Attribute("dsg_race_dragon_dragonfruit_red", "dsg_race_dragon_dragonfruit_red"), new Attribute("dsg_race_dragon_dragonfruit_yellow", "dsg_race_dragon_dragonfruit_yellow"), new Attribute("dsg_race_ferret_orange_juice", "dsg_race_ferret_orange_juice"), new Attribute("dsg_race_ferret_sausages", "dsg_race_ferret_sausages"), new Attribute("dsg_race_gryphon_pate_and_crackers", "dsg_race_gryphon_pate_and_crackers"), new Attribute("dsg_race_gryphon_two_tone_slushie", "dsg_race_gryphon_two_tone_slushie"), new Attribute("dsg_race_otter_berry_soda", "dsg_race_otter_berry_soda"), new Attribute("dsg_race_otter_fish_and_chips", "dsg_race_otter_fish_and_chips"), new Attribute("dsg_race_raccoon_cotton_candy_soda", "dsg_race_raccoon_cotton_candy_soda"), new Attribute("dsg_race_raccoon_popcorn", "dsg_race_raccoon_popcorn"), new Attribute("dsg_race_shark_grog", "dsg_race_shark_grog"), new Attribute("dsg_race_shark_tuna_sashimi", "dsg_race_shark_tuna_sashimi"), new Attribute("dsg_wetwipes_wetwipes", "dsg_wetwipes_wetwipes"), new Attribute("innoxia_cheat_inno_chans_gift", "innoxia_cheat_inno_chans_gift"), new Attribute("innoxia_cheat_unlikely_whammer", "innoxia_cheat_unlikely_whammer"), new Attribute("innoxia_food_doughnut", "innoxia_food_doughnut"), new Attribute("innoxia_food_doughnut_iced", "innoxia_food_doughnut_iced"), new Attribute("innoxia_food_doughnut_iced_sprinkles", "innoxia_food_doughnut_iced_sprinkles"), new Attribute("innoxia_pills_broodmother", "innoxia_pills_broodmother"), new Attribute("innoxia_pills_fertility", "innoxia_pills_fertility"), new Attribute("innoxia_pills_sterility", "innoxia_pills_sterility"), new Attribute("innoxia_potions_amazonian_ambrosia", "innoxia_potions_amazonian_ambrosia"), new Attribute("innoxia_potions_amazons_secret", "innoxia_potions_amazons_secret"), new Attribute("innoxia_quest_clothing_keys", "innoxia_quest_clothing_keys"), new Attribute("innoxia_quest_faire_ticket", "innoxia_quest_faire_ticket"), new Attribute("innoxia_quest_minotallys_pass", "innoxia_quest_minotallys_pass"), new Attribute("innoxia_quest_monica_milker", "innoxia_quest_monica_milker"), new Attribute("innoxia_quest_oglix_beer_token", "innoxia_quest_oglix_beer_token"), new Attribute("innoxia_quest_recorder", "innoxia_quest_recorder"), new Attribute("innoxia_quest_special_pass", "innoxia_quest_special_pass"), new Attribute("innoxia_quest_special_pass_elle", "innoxia_quest_special_pass_elle"), new Attribute("innoxia_race_alligator_gators_gumbo", "innoxia_race_alligator_gators_gumbo"), new Attribute("innoxia_race_alligator_swamp_water", "innoxia_race_alligator_swamp_water"), new Attribute("innoxia_race_angel_angels_tears", "innoxia_race_angel_angels_tears"), new Attribute("innoxia_race_badger_berry_trifle", "innoxia_race_badger_berry_trifle"), new Attribute("innoxia_race_badger_black_stripes_perry", "innoxia_race_badger_black_stripes_perry"), new Attribute("innoxia_race_bat_fruit_bats_juice_box", "innoxia_race_bat_fruit_bats_juice_box"), new Attribute("innoxia_race_bat_fruit_bats_salad", "innoxia_race_bat_fruit_bats_salad"), new Attribute("innoxia_race_cat_felines_fancy", "innoxia_race_cat_felines_fancy"), new Attribute("innoxia_race_cat_kittys_reward", "innoxia_race_cat_kittys_reward"), new Attribute("innoxia_race_cow_bubble_cream", "innoxia_race_cow_bubble_cream"), new Attribute("innoxia_race_cow_bubble_milk", "innoxia_race_cow_bubble_milk"), new Attribute("innoxia_race_deer_glade_springs", "innoxia_race_deer_glade_springs"), new Attribute("innoxia_race_deer_tree_shoots_salad", "innoxia_race_deer_tree_shoots_salad"), new Attribute("innoxia_race_demon_innoxias_gift", "innoxia_race_demon_innoxias_gift"), new Attribute("innoxia_race_demon_liliths_gift", "innoxia_race_demon_liliths_gift"), new Attribute("innoxia_race_dog_canine_crunch", "innoxia_race_dog_canine_crunch"), new Attribute("innoxia_race_dog_canine_crush", "innoxia_race_dog_canine_crush"), new Attribute("innoxia_race_fox_chicken_pot_pie", "innoxia_race_fox_chicken_pot_pie"), new Attribute("innoxia_race_fox_vulpines_vineyard", "innoxia_race_fox_vulpines_vineyard"), new Attribute("innoxia_race_goat_billys_best", "innoxia_race_goat_billys_best"), new Attribute("innoxia_race_goat_pans_flute", "innoxia_race_goat_pans_flute"), new Attribute("innoxia_race_harpy_bubblegum_lollipop", "innoxia_race_harpy_bubblegum_lollipop"), new Attribute("innoxia_race_harpy_harpy_perfume", "innoxia_race_harpy_harpy_perfume"), new Attribute("innoxia_race_horse_equine_cider", "innoxia_race_horse_equine_cider"), new Attribute("innoxia_race_horse_sugar_carrot_cube", "innoxia_race_horse_sugar_carrot_cube"), new Attribute("innoxia_race_human_bread_roll", "innoxia_race_human_bread_roll"), new Attribute("innoxia_race_human_vanilla_water", "innoxia_race_human_vanilla_water"), new Attribute("innoxia_race_imp_impish_brew", "innoxia_race_imp_impish_brew"), new Attribute("innoxia_race_mouse_barley_water", "innoxia_race_mouse_barley_water"), new Attribute("innoxia_race_mouse_cheese", "innoxia_race_mouse_cheese"), new Attribute("innoxia_race_none_mince_pie", "innoxia_race_none_mince_pie"), new Attribute("innoxia_race_panther_deep_roar", "innoxia_race_panther_deep_roar"), new Attribute("innoxia_race_panther_panthers_delight", "innoxia_race_panther_panthers_delight"), new Attribute("innoxia_race_pig_oinkers_fries", "innoxia_race_pig_oinkers_fries"), new Attribute("innoxia_race_pig_porcine_pop", "innoxia_race_pig_porcine_pop"), new Attribute("innoxia_race_rabbit_bunny_carrot_cake", "innoxia_race_rabbit_bunny_carrot_cake"), new Attribute("innoxia_race_rabbit_bunny_juice", "innoxia_race_rabbit_bunny_juice"), new Attribute("innoxia_race_raptor_energy_bar", "innoxia_race_raptor_energy_bar"), new Attribute("innoxia_race_raptor_energy_drink", "innoxia_race_raptor_energy_drink"), new Attribute("innoxia_race_rat_black_rats_rum", "innoxia_race_rat_black_rats_rum"), new Attribute("innoxia_race_rat_brown_rats_burger", "innoxia_race_rat_brown_rats_burger"), new Attribute("innoxia_race_reindeer_rudolphs_egg_nog", "innoxia_race_reindeer_rudolphs_egg_nog"), new Attribute("innoxia_race_reindeer_sugar_cookie", "innoxia_race_reindeer_sugar_cookie"), new Attribute("innoxia_race_sheep_ewes_brew", "innoxia_race_sheep_ewes_brew"), new Attribute("innoxia_race_sheep_woolly_goodness", "innoxia_race_sheep_woolly_goodness"), new Attribute("innoxia_race_slime_biojuice_canister", "innoxia_race_slime_biojuice_canister"), new Attribute("innoxia_race_slime_slime_quencher", "innoxia_race_slime_slime_quencher"), new Attribute("innoxia_race_squirrel_round_nuts", "innoxia_race_squirrel_round_nuts"), new Attribute("innoxia_race_squirrel_squirrel_java", "innoxia_race_squirrel_squirrel_java"), new Attribute("innoxia_race_wolf_meat_and_marrow", "innoxia_race_wolf_meat_and_marrow"), new Attribute("innoxia_race_wolf_wolf_whiskey", "innoxia_race_wolf_wolf_whiskey"), new Attribute("innoxia_slavery_freedom_certification", "innoxia_slavery_freedom_certification"), new Attribute("mintychip_race_salamander_apple_pie", "mintychip_race_salamander_apple_pie"), new Attribute("mintychip_race_salamander_hot_cocoa", "mintychip_race_salamander_hot_cocoa"), new Attribute("mintychip_race_salamander_iced_tea", "mintychip_race_salamander_iced_tea"), new Attribute("NoStepOnSnek_race_capybara_brownie", "NoStepOnSnek_race_capybara_brownie"), new Attribute("NoStepOnSnek_race_capybara_tea2go", "NoStepOnSnek_race_capybara_tea2go"), new Attribute("NoStepOnSnek_race_octopus_ink_vodka", "NoStepOnSnek_race_octopus_ink_vodka"), new Attribute("NoStepOnSnek_race_octopus_shrimp_cocktail", "NoStepOnSnek_race_octopus_shrimp_cocktail"), new Attribute("NoStepOnSnek_race_snake_eggs", "NoStepOnSnek_race_snake_eggs"), new Attribute("NoStepOnSnek_race_snake_oil", "NoStepOnSnek_race_snake_oil"), new Attribute("rfpnj_peach_peach", "rfpnj_peach_peach")});

        // endregion

        // region Weapons Initialization

        weaponsMap.put(WeaponType.RANGED, new Attribute[]{new Attribute("c4mg1rl_bows_hama_yumi", "c4mg1rl_bows_hama_yumi"), new Attribute("dsg_eep_cryoprism_cryoprism", "dsg_eep_cryoprism_cryoprism"), new Attribute("dsg_eep_liqstungun_coomgun", "dsg_eep_liqstungun_coomgun"), new Attribute("dsg_eep_liqstungun_liqstungun", "dsg_eep_liqstungun_liqstungun"), new Attribute("dsg_eep_pbweap_pblauncher", "dsg_eep_pbweap_pblauncher"), new Attribute("dsg_eep_pbweap_pbpistol", "dsg_eep_pbweap_pbpistol"), new Attribute("dsg_eep_pbweap_pbrifle", "dsg_eep_pbweap_pbrifle"), new Attribute("dsg_eep_taser_taser", "dsg_eep_taser_taser"), new Attribute("dsg_eep_trqrifle_trqrifle", "dsg_eep_trqrifle_trqrifle"), new Attribute("dsg_hlf_weap_gbshotgun", "dsg_hlf_weap_gbshotgun"), new Attribute("dsg_hlf_weap_pboltrifle", "dsg_hlf_weap_pboltrifle"), new Attribute("dsg_hlf_weap_pbomb", "dsg_hlf_weap_pbomb"), new Attribute("dsg_hlf_weap_pbrevolver", "dsg_hlf_weap_pbrevolver"), new Attribute("dsg_hlf_weap_pbsmg", "dsg_hlf_weap_pbsmg"), new Attribute("innoxia_bow_pistol_crossbow", "innoxia_bow_pistol_crossbow"), new Attribute("innoxia_bow_recurve", "innoxia_bow_recurve"), new Attribute("innoxia_bow_shortbow", "innoxia_bow_shortbow"), new Attribute("innoxia_feather_epic", "innoxia_feather_epic"), new Attribute("innoxia_feather_legendary", "innoxia_feather_legendary"), new Attribute("innoxia_feather_rare", "innoxia_feather_rare"), new Attribute("innoxia_gun_arcane_musket", "innoxia_gun_arcane_musket"), new Attribute("innoxia_gun_br14", "innoxia_gun_br14"), new Attribute("innoxia_gun_famase", "innoxia_gun_famase"), new Attribute("innoxia_gun_lar1a1", "innoxia_gun_lar1a1"), new Attribute("innoxia_gun_mkar", "innoxia_gun_mkar"), new Attribute("innoxia_gun_revolver", "innoxia_gun_revolver"), new Attribute("innoxia_gun_waspley_mk4_service", "innoxia_gun_waspley_mk4_service"), new Attribute("innoxia_gun_western_ppk", "innoxia_gun_western_ppk"), new Attribute("innoxia_lightningGlobe_lightning_globe", "innoxia_lightningGlobe_lightning_globe"), new Attribute("innoxia_lightningGlobe_lightning_globe_ring", "innoxia_lightningGlobe_lightning_globe_ring"), new Attribute("innoxia_thrown_tennis_ball", "innoxia_thrown_tennis_ball"), new Attribute("innoxia_thrown_yarn", "innoxia_thrown_yarn")});
        weaponsMap.put(WeaponType.MELEE, new Attribute[]{new Attribute("c4mg1rl_swords_muramasa", "c4mg1rl_swords_muramasa"), new Attribute("dsg_eep_enbaton_enbaton", "dsg_eep_enbaton_enbaton"), new Attribute("dsg_eep_riotshield_riotshield", "dsg_eep_riotshield_riotshield"), new Attribute("innoxia_arcanistStaff_arcanist_staff", "innoxia_arcanistStaff_arcanist_staff"), new Attribute("innoxia_axe_battle", "innoxia_axe_battle"), new Attribute("innoxia_bat_metal", "innoxia_bat_metal"), new Attribute("innoxia_bat_wooden", "innoxia_bat_wooden"), new Attribute("innoxia_bat_wooden_silly", "innoxia_bat_wooden_silly"), new Attribute("innoxia_bdsm_riding_crop", "innoxia_bdsm_riding_crop"), new Attribute("innoxia_blunt_morning_star", "innoxia_blunt_morning_star"), new Attribute("innoxia_cleaning_feather_duster", "innoxia_cleaning_feather_duster"), new Attribute("innoxia_cleaning_witch_broom", "innoxia_cleaning_witch_broom"), new Attribute("innoxia_crystal_epic", "innoxia_crystal_epic"), new Attribute("innoxia_crystal_legendary", "innoxia_crystal_legendary"), new Attribute("innoxia_crystal_rare", "innoxia_crystal_rare"), new Attribute("innoxia_dagger_dagger", "innoxia_dagger_dagger"), new Attribute("innoxia_europeanSwords_arming_sword", "innoxia_europeanSwords_arming_sword"), new Attribute("innoxia_europeanSwords_xiphos", "innoxia_europeanSwords_xiphos"), new Attribute("innoxia_europeanSwords_zweihander", "innoxia_europeanSwords_zweihander"), new Attribute("innoxia_japaneseSwords_katana", "innoxia_japaneseSwords_katana"), new Attribute("innoxia_japaneseSwords_wakizashi", "innoxia_japaneseSwords_wakizashi"), new Attribute("innoxia_kerambit_kerambit", "innoxia_kerambit_kerambit"), new Attribute("innoxia_knuckleDusters_knuckle_dusters", "innoxia_knuckleDusters_knuckle_dusters"), new Attribute("innoxia_pipe_pipe", "innoxia_pipe_pipe"), new Attribute("innoxia_scythe_scythe", "innoxia_scythe_scythe"), new Attribute("innoxia_shield_buckler", "innoxia_shield_buckler"), new Attribute("innoxia_shield_crude_wooden", "innoxia_shield_crude_wooden"), new Attribute("innoxia_spear_dory", "innoxia_spear_dory"), new Attribute("innoxia_utility_flashlight", "innoxia_utility_flashlight")});
